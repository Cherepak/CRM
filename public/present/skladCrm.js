...
export function SkladCRM() {
  return <div>
    <img className="image__present-CRM"
    src="image/sport/sport1.jpg"
    alt="CRM Спортивный"/>

    <h3 className="text-blue CRM__title3">Склад контроль ЭТО</h3>
    ...
    <ul className="text-blue">
      ...
      <li className="CRM__item item-margin font24">
        <img className="image__iconCRM" src="image/icon/sklad.png"/>
        <span className="">Контроль инвентаря на складе</span>
      </li>
      <li className="CRM__item item-margin font24">
